    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dni', models.CharField(blank=True, max_length=13, null=True, unique=True, verbose_name='Cédula o RUC')),
                ...
                ('groups', models.ManyToManyField(related_name='security_users', to='auth.group')),
                ('user_permissions', models.ManyToManyField(related_name='security_users', to='auth.permission')),
            ],
            options={
